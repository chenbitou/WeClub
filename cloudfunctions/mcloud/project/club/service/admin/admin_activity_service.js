...
class AdminActivityService extends BaseProjectAdminService {
	...
	async getMyActivityList(userId, {
		...
		let fields = 'ACTIVITY_METHOD,ACTIVITY_JOIN_CNT,ACTIVITY_TITLE,ACTIVITY_CATE_ID,ACTIVITY_CATE_NAME,ACTIVITY_EDIT_TIME,ACTIVITY_ADD_TIME,ACTIVITY_ORDER,ACTIVITY_STATUS,ACTIVITY_VOUCH,ACTIVITY_MAX_CNT,ACTIVITY_START,ACTIVITY_END,ACTIVITY_STOP,ACTIVITY_CANCEL_SET,ACTIVITY_CHECK_SET,ACTIVITY_QR,ACTIVITY_OBJ';
	...
	async delActivity(id) {
		this.AppError('[俱乐部]该功能暂不开放，如有需要请加作者微信：cclinux0730');
	...
	async getAdminActivityList({
		...
		let fields = 'ACTIVITY_USER_ID,ACTIVITY_TYPE,ACTIVITY_METHOD,ACTIVITY_JOIN_CNT,ACTIVITY_TITLE,ACTIVITY_CATE_ID,ACTIVITY_CATE_NAME,ACTIVITY_EDIT_TIME,ACTIVITY_ADD_TIME,ACTIVITY_ORDER,ACTIVITY_STATUS,ACTIVITY_VOUCH,ACTIVITY_MAX_CNT,ACTIVITY_START,ACTIVITY_END,ACTIVITY_STOP,ACTIVITY_CANCEL_SET,ACTIVITY_CHECK_SET,ACTIVITY_QR,ACTIVITY_OBJ,user.USER_NAME';
		...
		if (util.isDefined(search) && search) {
			...
			switch (sortType) {
				...
				case 'method': {
					where.and.ACTIVITY_METHOD = Number(sortVal);
					break;
				}
				case 'status': {
					where.and.ACTIVITY_STATUS = Number(sortVal);
