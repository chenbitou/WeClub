...
class ActivityController extends BaseProjectController {
	...
	async getActivityListOffline() {
		return await this.getActivityList(0);
	}

	async getActivityListOnline() {
		return await this.getActivityList(1);
	}


	/** 列表 */
	async getActivityList(method = 0) {
